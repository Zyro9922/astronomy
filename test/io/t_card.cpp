...
public:
    ...
    /**
     * @brief       Returns the card object of given card_type
     * @param[in]   card_type Type of card required ( Type of value stored )
    */
...
/**
 * @brief     Tests the card's cstring constructor
 * @details   This function performs testing by cheking the value of key , value after call
 * @note      Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests the card's string constructor
 * @details     This function performs testing by raising exceptions and checking the key , value after call
 * @note        Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests create_card function  that takes string 'value' as its argument
 * @details     This function performs testing by trying to create a card whose key's value is a string
 *              along with raising exceptions on invalid values of key,value and comment
 * @note        Refer to card_fixture for details of input_data
*/
...
/**
 * @brief        Tests create_card function  that takes boolean 'value' as its argument
 * @details      This function performs testing by trying to create a card whose keyword value is a boolean value
 * @note         Refer to card_fixture for details of input_data
 */
...
/**
 * @brief       Tests create_card function  that takes different kinds of numeric 'value'
 * @details     This function performs testing by trying to create a card whose keyword value is a numeric value
 *              This includes ( int, float ) types
 * @note        Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests create_card function  that takes complex 'value'
 * @details     This function performs testing by trying to create a card whose keyword value is a complex number
 * @note      Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests create_card function  which is used to create a commentary card
 * @details     This function performs testing by trying to create a card that only contains comment
 * @note        Here 'comment' refers to value of <strong>COMMENT</strong> keyword rather than general comments
 * @note      Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests whether the key is correctly obtained from the card
 * @note      Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests whether the value is correctly converted and obtained from the card
 * @note      Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests whether the value is correctly returned with the comment associated with the card
 * @note      Refer to card_fixture for details of input_data
*/
...
/**
 * @brief       Tests whether the value is correctly set in the card
 * @note      Refer to card_fixture for details of input_data
*/
